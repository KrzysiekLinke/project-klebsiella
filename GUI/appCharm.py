                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            -   The standard folder will be shown if no file is uploaded. When the upload fails to find the new directory, an error message will be displayed. 
                                The standard folder includes some data on which the model is trained and is mostly just for show. An error message is also displayed when there are no images within the folder.
